...
//             </button>
//             <span className="w-0 hd_w_one"></span>
//             <a className="navbar-brand" to="/">
//               <img src={Logo} />
//             </a>
//             <span className="w-0 hd_w_two"></span>
//             <button
//               className="navbar-toggler"
//               type="button"
//               data-bs-toggle="collapse"
...
//             >
//               <ul className="navbar-nav  m-2 mb-lg-0 text-end">
//                 <li className="nav-item m-2">
//                   <button
//                     className="btn btn-md-lg btn-warning me-3 px-4 fw-bold"
//                     type="Login"
//                   >
//                     Login
//                   </button>
...
//                 <li className="nav-item m-2">
//                   <button
//                     className="btn btn-md-lg btn-outline-warning me-3 px-4 text-dark fw-bold "
//                     type="submit"
//                   >
//                     Signup
//                   </button>
...
//                     <a
//                       className="nav-link mx-sm-0 mx-md-5"
//                       aria-current="page"
//                       to="/"
//                     >
//                       Explore
//                     </a>
//                     <link className="nav-link mx-sm-0 mx-md-5" to="/">
//                       Pricing
//                     </link>
//                     <link className="nav-link mx-sm-0 mx-md-5" to="/">
//                       Blog
